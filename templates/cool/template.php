...
// here we're putting the organisation logo in at the top of the secondary column
$template['web']['begin']['secondary']['container'] = "<!--secondary section-->\n<td valign=\"top\">\n<!--LOGO-->\n";
$template['web']['end']['secondary']['container'] ='</td><!--/secondary section-->';

$template['web']['whole']['newsletter']['logo'] = <<<WEBLOGO
 <!--section-->
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                                    <img width="204" src="<!--CONTENT-->" alt="Organisation logo">
                                </td>
                            </tr>
                        </table>
                        <!--/section-->
...
$template['web']['begin']['main']['article'] = '<!--main article--><h2 style="font-family: Helvetica, Arial, sans-serif; font-size: 18px; margin: 0px; padding: 0px; margin-bottom: 5px; text-shadow: 1px 1px 1px #333333; color: #62b6ee;"><!--ARTICLE TITLE--></h2>';
